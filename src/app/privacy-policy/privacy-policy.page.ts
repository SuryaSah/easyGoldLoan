...
export class PrivacyPolicyPage implements OnInit {
  technologies : Array<{ name: string, description: string}> = [
    ...
    {
       name : 'Collection of Personally Identifiable Information and other Information',
    ...
    {
       name : 'Use of Demographic / Profile Data / Your Information',
       description : `We use personal information to provide the services you request. To the extent we use your personal information to market to you, we will provide you the ability to opt-out of such uses. We use your personal information to resolve disputes; troubleshoot problems; help promote a safe service; collect money; measure consumer interest in our products and services, inform you about online and offline offers, products, services, and updates; customize your experience; detect and protect us against error, fraud and other criminal activity; enforce our terms and conditions; and as otherwise described to you at the time of collection.
    ...
    },
    {
      ...
      description : `Our Website links to other websites that may collect personally identifiable information about you. Myntra is not responsible for the privacy practices or the content of those linked websites.`
    },
    {
      name : 'Security Precautions',
    ...
    {
      name : 'Advertisements on www.myntra.com',
      description : `We use third-party advertising companies to serve ads when you visit our Website. These companies may use information (not including your name, address, email address, or telephone number) about your visits to this and other websites in order to provide advertisements about goods and services of interest to you.`
    },
    {
      name : 'Your Consent',
    ...
    },
    {
      ...
      description : `In accordance with Information Technology Act 2000 and rules made there under, the name and contact details of the Grievance Officer are provided below:

      Mr. Arun Kumar S
      
      Designation: Senior Manager - CC - Operations
      ...
      Contact us: ccmanager@myntra.com
